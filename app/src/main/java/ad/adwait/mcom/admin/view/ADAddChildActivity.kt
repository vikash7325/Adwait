...
import ad.adwait.mcom.admin.model.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit_btn.setOnClickListener(View.OnClickListener {
            ...
            if (TextUtils.isEmpty(name)) {
                ...
                var accountRequest = ad.adwait.mcom.admin.model.ADCreateAccountRequest(
                    holderName,
                    emailId,
                ...
                call.enqueue(object : Callback<ad.adwait.mcom.admin.model.ADCreateAccountResponse> {

                    override fun onResponse(
                        call: Call<ad.adwait.mcom.admin.model.ADCreateAccountResponse>?,
                        response: Response<ad.adwait.mcom.admin.model.ADCreateAccountResponse>?
                    ) {
                        if (response != null && response.isSuccessful) {
                            if (response.body().isSuccessFlag) {
                                if (response.body() != null) {
                                    val fullResponse: ad.adwait.mcom.admin.model.ADCreateAccountResponse = response?.body()!!
                    ...
                    override fun onFailure(call: Call<ad.adwait.mcom.admin.model.ADCreateAccountResponse>?, t: Throwable?) {
                        hideProgress(mProgressDialog)
