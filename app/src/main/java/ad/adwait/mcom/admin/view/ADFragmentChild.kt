...
class ADFragmentChild : androidx.fragment.app.Fragment(), ad.adwait.mcom.utils.ChildItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    private lateinit var childAdapter: ad.adwait.mcom.admin.adapter.ADChildListAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        childAdapter = ad.adwait.mcom.admin.adapter.ADChildListAdapter(activity, mChildListData)
        ...
        var callBack: ItemTouchHelper.SimpleCallback =
            ad.adwait.mcom.utils.ChildItemTouchHelper(0, ItemTouchHelper.LEFT, this)
    ...
    override fun onSwiped(viewHolder: androidx.recyclerview.widget.RecyclerView.ViewHolder?, direction: Int, position: Int) {
        ...
        if (viewHolder is ad.adwait.mcom.admin.adapter.ADChildListAdapter.MyViewHolder) {
