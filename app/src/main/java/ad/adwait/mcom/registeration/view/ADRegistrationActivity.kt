package ad.adwait.mcom.registeration.view
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ref_submit_btn.setOnClickListener(View.OnClickListener {
            ...
            if (TextUtils.isEmpty(code)) {
                ...
                if (code.equals(ad.adwait.mcom.utils.ADConstants.ADMIN_REFERRAL_CODE)) {
        ...
        mFirebaseDatabase.child(mUserId).setValue(user)
            .addOnSuccessListener {
                ...
                celebration_view.build()
                    ...
                    .streamFor(ad.adwait.mcom.utils.ADConstants.ANIMATION_COUNT, ad.adwait.mcom.utils.ADConstants.ANIMATION_EMITTING_TIME)
            }
