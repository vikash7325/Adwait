...
import ad.adwait.mcom.donation.model.*
import ad.adwait.mcom.my_mentee.view.ADMonthlySplitActivity
import ad.adwait.mcom.registeration.model.ADLastCheckout
...
class ADDonationFragment : ADBaseFragment(), PaymentResultWithDataListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        done_btn.setOnClickListener(View.OnClickListener {
            ...
            if (activity is ADDashboardActivity) {
                ...
                (activity as ADDashboardActivity).menuAction(ad.adwait.mcom.utils.ADConstants.MENU_HOME, "")
            } else {
    ...
    private fun createOrderOrSub() {
        ...
        if (monthly_subscription.isChecked) {
            ...
            call.enqueue(object : Callback<ad.adwait.mcom.donation.model.ADCreateOrderResponse> {
                override fun onResponse(
                    call: Call<ad.adwait.mcom.donation.model.ADCreateOrderResponse>?,
                    response: Response<ad.adwait.mcom.donation.model.ADCreateOrderResponse>?
                ) {

                    if (response != null && response.isSuccessful) {
                        if (response.body().successFlag) {
                            if (response.body() != null) {
                                val fullResponse: ad.adwait.mcom.donation.model.ADCreateOrderResponse = response?.body()!!
                ...
                override fun onFailure(call: Call<ad.adwait.mcom.donation.model.ADCreateOrderResponse>?, t: Throwable?) {
                    (activity as ADBaseActivity).hideProgress(mProgressDialog)
    ...
    private fun createSubscription(amount: Int) {
        ...
        call.enqueue(object : Callback<ad.adwait.mcom.subscription.model.ADSubscriptionResponse> {

            override fun onResponse(
                call: Call<ad.adwait.mcom.subscription.model.ADSubscriptionResponse>?,
                response: Response<ad.adwait.mcom.subscription.model.ADSubscriptionResponse>?
            ) {

                if (response != null && response.isSuccessful) {
                    if (response.body().isSuccessFlag) {
                        if (response.body() != null) {
                            val fullResponse: ad.adwait.mcom.subscription.model.ADSubscriptionResponse = response?.body()!!
            ...
            override fun onFailure(call: Call<ad.adwait.mcom.subscription.model.ADSubscriptionResponse>?, t: Throwable?) {
                (activity as ADBaseActivity).hideProgress(mProgressDialog)
            }
        })
    }
    ...
    private fun startPayment(data: ad.adwait.mcom.donation.model.ADCreateOrderData?, sub_id: String) {
    ...
    private fun verifySignature(paymentData: PaymentData?) {
        try {
            ...
            call.enqueue(object : Callback<ad.adwait.mcom.donation.model.ADSignVerifyResponse> {

                override fun onResponse(
                    call: Call<ad.adwait.mcom.donation.model.ADSignVerifyResponse>?,
                    response: Response<ad.adwait.mcom.donation.model.ADSignVerifyResponse>?
                ) {
                    if (response != null && response.isSuccessful) {
                        if (response.body().isSuccessFlag) {
                            if (response.body() != null) {
                                val fullData: ad.adwait.mcom.donation.model.ADSignVerifyResponse = response?.body()!!
                ...
                override fun onFailure(call: Call<ad.adwait.mcom.donation.model.ADSignVerifyResponse>?, t: Throwable?) {
    ...
    private fun fetchPaymentMethod(paymentData: PaymentData?, status: Boolean) {
        try {
            ...
            call.enqueue(object : Callback<ad.adwait.mcom.donation.model.ADPaymentMethodResponse> {

                override fun onResponse(
                    call: Call<ad.adwait.mcom.donation.model.ADPaymentMethodResponse>?,
                    response: Response<ad.adwait.mcom.donation.model.ADPaymentMethodResponse>?
                ) {
                    if (response != null && response.isSuccessful) {
                        if (response.body().isSuccessFlag) {
                            if (response.body() != null) {
                                val fullData: ad.adwait.mcom.donation.model.ADPaymentMethodResponse = response?.body()!!
                                checkAmountOfChild(
                                    paymentData,
                                    status,
